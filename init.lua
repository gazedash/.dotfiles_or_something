...
CloseAllFloatingWindows = function()                                                      
...
vim.keymap.set("n", "<Esc>", CloseAllFloatingWindows)
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'javascript', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim' },
